...
ADD_ANGULAR_MODULES = ['horizon.dashboard.admin.topconsumersplugin.topconsumerspanel']
...
ADD_SCSS_FILES = ['dashboard/admin/topconsumersplugin/topconsumerspanel/topconsumerspanel.scss']
